...
active_text_color="#44D62C"
active_bg=
active_underline="#4D4DFF"

inactive_text_color="#DB3EB1"
inactive_bg=
inactive_underline=
  ...
  while IFS="[ .\.]" read -r wid ws cname cls host title; do
    ...
    *$cls*) continue ;;
    ...
    "icon")
      ...
      TeXstudio) w_name='󰧨' ;;
      mpv) w_name='󰐌' ;;
      Xfce4-power-manager-settings) w_name='󰒃' ;;
      Polkit-gnome-authentication-agent-1) w_name='󰌾' ;;
      *) w_name="$cls" ;;
      esac
      ;;
    esac
